...
public function create(Request $request, Response $response): Response {
    try {
        ...
        // 2. Validar el FORMATO de cada campo
        ...
        // 4. Ejecutar la transacción (ESTA ES LA PARTE QUE FALTABA)
        ...
        try {
            ...
            $this->db->rollBack();
            throw $e; // Lanza la excepción para que sea capturada por el catch exterior
        }
